...
class Cliente():
    ...
    def __init__(self, identificador, nombre, email, telefono, direccion):
        ...
        if direccion == "":
            raise ValueError("El dirección es obligatorio") 
...
try:
    cliente1 = Cliente(1, "Juan", "juangmail.com", "987654321", "Calle Principal")
...
try:
    cliente2 = ClienteRegular(2, "Ana", "ana@gmail.com", "987654322", "Avda. Única S/N", 0)

    print(cliente2.obtener_datos())
except ValueError as error:
    print("Ha ocurrido un error:", error)

try:
    cliente3 = ClientePremium(3, "Luis", "luis@gmail.com", "987654323", "Pasaje Cerrado", "Gold", 10)

    print(cliente3.obtener_datos())
except ValueError as error:
    print("Ha ocurrido un error:", error)

try:
    cliente4 = ClienteCorporativo(4, "María", "maria@gmail.com", "987654324", "Calle Larga", "Supermercado X", 20000000)

    print(cliente4.obtener_datos())
except ValueError as error:
    print("Ha ocurrido un error:", error)