# Ejercicio: Registro de cursos

# Una academia necesita almacenar información de varios cursos. Cada curso debe representarse mediante un diccionario y todos deben guardarse dentro de una lista.

# Cada curso debe contener:
# - Nombre
# - Duración en horas
# - Cantidad de estudiantes
# - Estado ("Disponible" o "Completo")

# Crea una lista con al menos cinco cursos y desarrolla un programa que permita:

# Mostrar todos los cursos y sus datos.
# Mostrar solamente los cursos disponibles.
# Agregar un nuevo curso a la lista.
# Modificar la cantidad de estudiantes de un curso.
# Cambiar el estado de un curso.
# Eliminar un curso según su nombre.
# Contar cuántos cursos están disponibles.
# Mostrar los cursos que duren más de 30 horas.
# Calcular el total de estudiantes registrados entre todos los cursos.
# Mostrar la lista actualizada al finalizar.
