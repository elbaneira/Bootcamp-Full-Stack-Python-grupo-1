# ==========================================
# FUNCIONES (Definidas AFUERA de main)
# ==========================================
...
# ➕ NUEVA FUNCIÓN: Definida fuera de main
...
def main():
    ...
    for dia in dias:
        while True:
            try:
                ...
                if litros < 0:
                    print("⚠️ Por favor, ingrese una cantidad válida (no negativa).")
                    continue
    ...
    dias_sin_agua = contar_dias_corte(consumo)  # <--- Llamamos a la nueva función aquí
    ...
    # Mostrar advertencia de corte si aplica 
    if dias_sin_agua > 0:
        print(f"• Días con posible corte de agua (0L): {dias_sin_agua} día(s) ⚠️")
